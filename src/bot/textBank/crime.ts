...
export const badCrimes = [
	...
	"While trying to commit fraud, you overdrafted and have to pay a {} overdraft fee.",
	...
	"Tried to do crime but you are in fact terrible. - {}",
	"You tried to steal from John Wick. It did not go well. - {}",
];

...
export const jobPaths: JobList = {
	...
	medical: {
		...
		emergencyMeetingText:
			"A patient is dying! Come to the emergency meeting and save this patient! If you do not attend you will be fined 30% of your balance for medical malpractice and be fired!",
		tiers: [
			{
			...
			{
				title: "Graduate Medical Student",
				basePay: -5000,
				maxPay: 0,
				requirements: {
					technicalSkills: 25,

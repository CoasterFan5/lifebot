...
export const jobWork: LifebotCommandHandler = async (
	...
	// Anti-bot code
	const checkAntiBot = Math.random() < 10;
	...
	embedList.push(
		new EmbedBuilder()
			...
			.setDescription(
				`${user.jobCompany} has called an all-hands on deck meeting. If you do not attend by click the button attatched to this message, you will lose your job and be fined 30% of your balance.`,
			)
			.setFooter({
